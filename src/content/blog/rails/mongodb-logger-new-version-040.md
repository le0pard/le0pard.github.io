...
description: MongodbLogger 0.4.0 for Rails 3. What's new?
pubDate: 2012-12-08
tags:
  - rails
  - mongodb
...
- Changed param "safe_insert" to "write_options", because "safe" options is deprecated in mongo adapter. Detailed information about this option you can read [here](https://github.com/mongodb/mongo-ruby-driver/wiki/Write-Concern).
