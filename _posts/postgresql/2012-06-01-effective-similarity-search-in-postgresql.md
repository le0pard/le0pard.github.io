...
<div class="aligncenter">
  <img src="http://latex.codecogs.com/png.latex?\LARGE%20\dpi{120}%20\fn_phv%20S(A,B)%20=%20\frac{N_{i}}{(N_{a}%20+%20N_{b})}" alt="simplest0" class="aligncenter size-full" />
</div>

or only

<div class="aligncenter">
  <img src="http://latex.codecogs.com/png.latex?\LARGE%20\dpi{120}%20\fn_phv%20S(A,B)%20=%20\frac{N_{i}}{N_{u}}" alt="simplest123" class="aligncenter size-full" />
</div>
...
<div class="aligncenter">
  <img src="http://latex.codecogs.com/png.latex?\LARGE%20\dpi{120}%20\fn_phv%20S(A,B)%20=%20\frac{N_{i}}{\sqrt{N_{a}%20*%20N_{b}}}" alt="simplest1" class="aligncenter size-full" />
</div>
...
<div class="aligncenter">
  <img src="http://latex.codecogs.com/png.latex?\LARGE%20\dpi{120}%20\fn_phv%20S(A,B)%20=%20\frac{\sum_{i%20%3C%20N_{a},%20j%20%3C%20N_{b},%20A_{i}%20=%20B_{j}}TF_{i}%20*%20TF_{j}}{\sqrt{\sum_{i%20%3C%20N_{a}}TF_{i}^{2}%20*%20\sum_{j%20%3C%20N_{b}}TF_{j}^{2}}}" alt="simplest2"  class="aligncenter size-full" />
</div>
...
<table class="describe-table">
  <tbody>
    <tr>
      <td>
        <a href="/assets/images/postgresql/smlar/chart1.png"><img src="/assets/images/postgresql/smlar/chart1.png" alt="" title="chart1" class="alignleft size-full wp-image-1956" /></a>
      </td>
      <td>
        <a href="/assets/images/postgresql/smlar/chart2.png"><img src="/assets/images/postgresql/smlar/chart2.png" alt="" title="chart2" class="alignleft size-full wp-image-1957" /></a>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>
        <a href="/assets/images/postgresql/smlar/11.png">
          <img src="/assets/images/postgresql/smlar/11-300x300.png" alt="" title="11" class="aligncenter size-medium wp-image-1952" />
        </a>
      </td>
      <td>
        <a href="/assets/images/postgresql/smlar/12.gif">
          <img src="/assets/images/postgresql/smlar/12-264x300.gif" alt="" title="12" class="aligncenter size-medium wp-image-1953" />
        </a>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>
        <a href="/assets/images/postgresql/smlar/689545_65148464.jpg">
          <img src="/assets/images/postgresql/smlar/689545_65148464-300x225.jpg" alt="" title="689545_65148464" class="aligncenter size-medium wp-image-1954" />
        </a>
      </td>
      <td>
        <a href="/assets/images/postgresql/smlar/689545_651484642.jpg">
          <img src="/assets/images/postgresql/smlar/689545_651484642-300x225.jpg" alt="" title="689545_651484642" class="aligncenter size-medium wp-image-1955" />
        </a>
      </td>
    </tr>
    <tr>
